...
│       ├── Qwen3_14B_AllVersions_JordanPeterson_Comparison.ipynb  # Qwen3 v1/v2/v3 vs base
...
`Qwen3_14B_AllVersions_JordanPeterson_Comparison.ipynb` compares all four Qwen3-14B
checkpoints (Base, V1, V2, V3) side by side. Answers three research questions:
...
3. How do all fine-tuned versions compare to the base model?
...
- Single inference wrapper: `generate_response()` (Qwen3 ChatML, same for all 4)
- Generated by `/tmp/make_qwen3_versions_comparison_notebook.py`

**Actual results (run 2026-02-21):**

| Metric | Base | V1 | V2 | V3 |
|--------|------|----|----|-----|
| Avg Perplexity | 19.1 | 12.8 | **10.0** | 11.0 |
| Avg TF-IDF Sim | **0.061** | 0.054 | 0.044 | 0.027 |
| Avg Keyword Density | **4.19%** | 3.30% | 2.26% | 2.62% |
| Avg Response Length | 204 w | 250 w | 218 w | 181 w |
| Avg TTR | **0.661** | 0.380 | 0.551 | 0.586 |
...
- Back-matter removal (indexes, figure lists) is the highest-leverage next data fix
